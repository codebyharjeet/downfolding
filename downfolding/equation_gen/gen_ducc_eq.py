...
expr = wt.contract(Fs2,minrank=0,maxrank=4)
...
expr = wt.contract(Ws1,minrank=0,maxrank=4)
...
expr = wt.contract(Ws2,minrank=0,maxrank=4)
...
expr = wt.contract(Fs1s1,minrank=0,maxrank=4)
...
expr = wt.contract(Fs1s2,minrank=0,maxrank=4)
...
expr = wt.contract(Fs2s1,minrank=0,maxrank=4)
...
expr = wt.contract(Fs2s2,minrank=0,maxrank=4)
...
expr = wt.contract(Ws1s1,minrank=0,maxrank=4)
...
expr = wt.contract(Ws1s2,minrank=0,maxrank=4)
...
expr = wt.contract(Ws2s1,minrank=0,maxrank=4)
...
expr = wt.contract(Ws2s2,minrank=0,maxrank=4)
...
expr = wt.contract(Fs1s1s1,minrank=0,maxrank=4)
...
expr = wt.contract(Fs1s1s2,minrank=0,maxrank=4)
...
expr = wt.contract(Fs1s2s1,minrank=0,maxrank=4)
...
expr = wt.contract(Fs1s2s2,minrank=0,maxrank=4)
...
expr = wt.contract(Fs2s1s1,minrank=0,maxrank=4)
...
expr = wt.contract(Fs2s1s2,minrank=0,maxrank=4)
...
expr = wt.contract(Fs2s2s1,minrank=0,maxrank=4)
...
expr = wt.contract(Fs2s2s2,minrank=0,maxrank=4)
