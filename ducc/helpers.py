...
def get_integral_blocks(fmat,vmat,n_a,n_b,n_orb):
    ...
    v["ooov"] = vmat_1[0:n_a+n_b , 0:n_a+n_b , 0:n_a+n_b , n_a+n_b:2*n_orb]

    v["ovoo"] = vmat_1[0:n_a+n_b , n_a+n_b:2*n_orb , 0:n_a+n_b , 0:n_a+n_b]

    v["ovov"] = vmat_1[0:n_a+n_b , n_a+n_b:2*n_orb , 0:n_a+n_b , n_a+n_b:2*n_orb]

    v["oovv"] = vmat_1[0:n_a+n_b , 0:n_a+n_b , n_a+n_b:2*n_orb , n_a+n_b:2*n_orb]

    v["vvoo"] = vmat_1[n_a+n_b:2*n_orb , n_a+n_b:2*n_orb , 0:n_a+n_b , 0:n_a+n_b]

    v["ovvv"] = vmat_1[0:n_a+n_b , n_a+n_b:2*n_orb , n_a+n_b:2*n_orb , n_a+n_b:2*n_orb]

    v["vvov"] = vmat_1[n_a+n_b:2*n_orb , n_a+n_b:2*n_orb , 0:n_a+n_b , n_a+n_b:2*n_orb]

    v["vvvv"] = vmat_1[n_a+n_b:2*n_orb , n_a+n_b:2*n_orb , n_a+n_b:2*n_orb , n_a+n_b:2*n_orb]
